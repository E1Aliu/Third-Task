        ...
        <div className='popup-container'>
            ...
            <div className='popup-card' style={{display: popup ? 'block' : 'none'}}>
                ...
                <div className='buttons'>
                    <button className='button button1' onClick={closePopup} type='button'>Cancel</button>
                    <button className='button button2' onClick={closePopup} type='button'>Save</button>
                </div>
            </div>
